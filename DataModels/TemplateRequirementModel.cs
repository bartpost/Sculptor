...
{
    public class TemplateRequirementModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        private ObservableCollection<TemplateRequirementModel> childRequirements;

        public TemplateRequirementModel()
        {
        }
        ...
        public ObservableCollection<TemplateRequirementModel> ChildRequirements
        {
            get
            {
